// ALTERED AND CUSTOMIZED BY TARA SIEGEL FOR USE IN PERSONAL PROJECT
            ...
            this.axes.forEach(function (axis) {
                ...
                if (axis.gridlineShapes === null) {
                    if (axis.showGridlines || (axis.showGridlines === null && !axis._hasCategories() && ((!xGridSet && axis.position === "x") || (!yGridSet && axis.position === "y")))) {
                        ...
                        axis.gridlineShapes = this._group.append("g").attr("class", "gridlines").style("background-color", "grey");
                        if (axis.position === "x") {
                            xGridSet = true;
                        } else {
                            yGridSet = true;
                ...
                if (axis.shapes === null) {
                    ...
                    axis.shapes = this._group.append("g").attr("class", "axis").style("color", "pink");
                    firstDraw = true;
                }
                ...
                if (transform !== null && axis._draw !== null) {
                    ...
                    if (axis.gridlineShapes !== null) {
                        handleTrans(axis.gridlineShapes).call(axis._draw.tickSize(gridSize, 0, 0).tickFormat("")).attr("transform", gridTransform).style("color", "Pink");
                    }
                    // Move labels around
                ...
                if (!this.noFormats) {
                    ...
                    if (axis.gridlineShapes !== null) {
                        ...
                        //handleTrans(axis.gridlineShapes.selectAll(".tick"))
                        //    .style("opacity", "0.3");
                        handleTrans(axis.gridlineShapes.selectAll("line:nth-child(2n)"))
                            .style("opacity", "0.9");
                        //handleTrans(axis.gridlineShapes.selectAll(".tick:nth-last-child(1)"))
                            //.style("opacity", "1");
                    }
                }
                ...
                if (!axis.hidden && (axis.position === "x" || axis.position === "y")) {
                    axis.titleShape = this._group.append("text").attr("class", "axis title").attr("id", "title");
                    axis.titleShape
                        .attr("x", titleX)
                        .attr("y", titleY)
                    ...
                    if (axis === firstX) {
                        axis.titleShape.each(function () {
                            d3.select(this).attr("y", titleY + this.getBBox().height / 1.15);
                        });
                    } else if (axis === firstY) {
                        axis.titleShape.each(function () {
                            d3.select(this).attr("x", titleX + this.getBBox().height / 1.15);
                        });
                    }
                }
               // }
            ...
            theseShapes.append("text")
                ...
                .call(function () {
                    if (!self.chart.noFormats) {
                        this.style("font-size", (self.chart._heightPixels() / 35 > 10 ? self.chart._heightPixels() / 35 : 10) + "px")
                            .style("color", "pink")
                            .style("shape-rendering", "crispEdges");
                    }
                })
